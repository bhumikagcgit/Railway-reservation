...
<body>
    <h3> LIST OF AVAILABLE TRAINS </h3>
...
<%
        ...
        try {
            ...
            String query=("select TRAIN_NO, TNAME,FRM_STATION,TO_STATION,DEP_TIME,ARR_TIME from trains t ");
...
%>
   ...
   <button type="submit" class="btn btn-warning" onclick="location = 'adminprof.html'">back</button>
   </div>
</body>
</html>
