...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body>
         <div  class="admin">
             <h1 style="margin-top: 100px; margin-left: 200px; color:  #ffccff;"> YOU CAN PRINT YOUR TICKETS HERE  BY ENTERING YOUR USERID </h1>
                                                                                                                                                                                                                                                                                                                                                                                                  <br>
         <br>
        <form class="form-horizontal"  action="printticketactn.jsp" method="post">
    ...
    <div class="form-group" style="margin-left: 400px">
      <label class="control col-sm-3"  style="color: white!important;max-width:14%">NAME</label>
      <div class="col-sm-4">
      ...
      <div class="col-sm-4">
        ...
        <div class="form-group" style="margin-left: 400px">
      <label class="control col-sm-3" style="color: white!important;max-width:14%">TRAIN NUMBER:</label>
      <div class="col-sm-4">
        <input class="form-control" placeholder="enter the train no" name="trainno">
      </div>
    </div>
        <br>
        <br>
